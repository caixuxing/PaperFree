...
{
    public class ModifyOutpatientEmergencyCmd:IRequest<bool>
    {
        ...
        public class ModifyOutpatientEmergencyCmdValidate : AbstractValidator<ModifyOutpatientEmergencyCmd>
        {
            public ModifyOutpatientEmergencyCmdValidate()
            {
