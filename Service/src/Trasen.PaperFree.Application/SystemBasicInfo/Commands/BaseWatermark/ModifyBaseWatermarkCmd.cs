    ...
    public class ModifyBaseWatermarkCmd : IRequest<bool>
    {
        ...
        public class ModifyBaseWatermarkValidate : AbstractValidator<ModifyBaseWatermarkCmd>
        {
            ...
            public ModifyBaseWatermarkValidate()
            {
                ...
                RuleFor(x => x.Color).NotEmpty().WithMessage("颜色不能为空！").MaximumLength(100).WithMessage("颜色长度不能超过100个字符");
                ...
                RuleFor(x => x.PicX).MaximumLength(10).WithMessage("PicX长度不能超过10个字符");
                RuleFor(x => x.PicY).MaximumLength(10).WithMessage("PicY长度不能超过10个字符");
                ...
                RuleFor(x => x.WatermarkName).NotEmpty().WithMessage("水印名称不能为空！").MaximumLength(100).WithMessage("水印名称长度不能超过100个字符");
