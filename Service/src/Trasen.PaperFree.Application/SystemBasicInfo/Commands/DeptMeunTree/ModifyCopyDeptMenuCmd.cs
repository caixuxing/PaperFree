...
namespace Trasen.PaperFree.Application.SystemBasicInfo.Commands.DeptMeunTree
{
    ...
    public record CreateCopyDeptMeunTreeCmdsListCmd(CreateCopyDeptMenuCmd cmd) : IRequest<bool>;
    public record CreateCopyDeptMenuCmd
    {
        /// <summary>
        /// 科室编码
        /// </summary>
        ...
        public class CreateCopyDeptMenuCmdValidate : AbstractValidator<CreateCopyDeptMenuCmd>
        {
            public CreateCopyDeptMenuCmdValidate()
            {
    ...
    public record TreeDataCopylist
    {
        /// <summary>
        /// 归档目录ID
        /// </summary>
        ...
        public class TreeDataCopylistValidate : AbstractValidator<TreeDataCopylist>
        {
            private IDeptMenuTreeRepo deptMenuTreeRepo;

            public TreeDataCopylistValidate(IDeptMenuTreeRepo menuTreeRepo)
            {
