...
execute immediate 'CREATE TABLE "ANNOTATION_TABLE" (
    ...
    "DEPT_CODE" NVARCHAR2(100) NOT NULL,
...
execute immediate 'CREATE TABLE "ARCHIVE_APPLY" (
    ...
    "CURRENT_APPROVAL_NODE_ID" NVARCHAR2(50),
    "CURRENT_APPROVAL_NODE_NAME" NVARCHAR2(50),
    "NODE_APPROVA_NAME" NVARCHAR2(20),
    "APPLY_PERSON_NAME" NVARCHAR2(20) NOT NULL,
    "ORG_CODE" NVARCHAR2(50) NOT NULL,
    "HOSP_CODE" NVARCHAR2(50) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    "CREATION_TIME" TIMESTAMP(7) NOT NULL,
...
COMMENT ON COLUMN "ARCHIVE_APPLY"."CURRENT_APPROVAL_NODE_NAME" is N'当前审批节点名称'
/

COMMENT ON COLUMN "ARCHIVE_APPLY"."NODE_APPROVA_NAME" is N'当前节点审批人名称'
/

COMMENT ON COLUMN "ARCHIVE_APPLY"."APPLY_PERSON_NAME" is N'申请人姓名'
/

COMMENT ON COLUMN "ARCHIVE_APPLY"."ORG_CODE" is N'机构编码'
/

COMMENT ON COLUMN "ARCHIVE_APPLY"."HOSP_CODE" is N'院区编码'
/
...
execute immediate 'CREATE TABLE "ARCHIVER_MEUM" (
    "ID" NVARCHAR2(50) NOT NULL,
    "MENU_NAME" NVARCHAR2(30) NOT NULL,
    ...
    "IS_HIGHSHOTS" NVARCHAR2(2000) NOT NULL,
    "IS_SIGNATURE" NVARCHAR2(2000) NOT NULL,
    "IS_ALLORG" NVARCHAR2(2000) NOT NULL,
    "ORG_CODE" NVARCHAR2(50) NOT NULL,
    "HOSP_CODE" NVARCHAR2(50) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    "CREATION_TIME" TIMESTAMP(7) NOT NULL,
...
COMMENT ON COLUMN "ARCHIVER_MEUM"."MENU_NAME" is N'目录名称'
/

COMMENT ON COLUMN "ARCHIVER_MEUM"."PARENT_ID" is N'上级目录ID'
/
...
COMMENT ON COLUMN "ARCHIVER_MEUM"."HOSP_CODE" is N'院区编码'
/
...
execute immediate 'CREATE TABLE "BASE_WATERMARK" (
    ...
    "ORG_CODE" NVARCHAR2(50) NOT NULL,
    "HOSP_CODE" NVARCHAR2(50) NOT NULL,
    "INPUT_CODE" NVARCHAR2(50) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    "CREATION_TIME" TIMESTAMP(7) NOT NULL,
    "LAST_MODIFY_TIME" TIMESTAMP(7),
    "LAST_MODIFY_ID" NVARCHAR2(50),
...
execute immediate 'CREATE TABLE "DEPT_MEUM_TREE" (
    "ID" NVARCHAR2(50) NOT NULL,
    "DEPT_ID" NVARCHAR2(100) NOT NULL,
    "ARCHIVER_MEUM_ID" NVARCHAR2(50) NOT NULL,
    "PARENT_ID" NVARCHAR2(50),
    "IS_REQUIRED" NVARCHAR2(20) NOT NULL,
    "ORG_CODE" NVARCHAR2(50) NOT NULL,
    "HOSP_CODE" NVARCHAR2(50) NOT NULL,
    "INPUT_CODE" NVARCHAR2(50) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    ...
    "ROW_VERSION" RAW(8) NOT NULL,
    "IS_DELETED" NUMBER(1) NOT NULL,
    CONSTRAINT "PK_DEPT_MEUM_TREE" PRIMARY KEY ("ID")
)';
END;
/

CREATE OR REPLACE TRIGGER "rowversion_DEPT_MEUM_TREE"
BEFORE INSERT OR UPDATE ON "DEPT_MEUM_TREE"
FOR EACH ROW
BEGIN
  :NEW."ROW_VERSION" := UTL_RAW.CAST_FROM_BINARY_INTEGER(UTL_RAW.CAST_TO_BINARY_INTEGER(NVL(:OLD."ROW_VERSION", '00000000')) + 1);
END;
...
COMMENT ON TABLE "DEPT_MEUM_TREE" is N'必传文件配置'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."ID" is N'主键ID'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."DEPT_ID" is N'科室ID'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."ARCHIVER_MEUM_ID" is N'归档目录模板ID'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."PARENT_ID" is N'上级目录ID'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."IS_REQUIRED" is N'是否必填'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."ORG_CODE" is N'使用机构'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."HOSP_CODE" is N'院区编码'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."INPUT_CODE" is N'辖区编码'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."CREATOR_ID" is N'创建人ID'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."CREATION_TIME" is N'创建时间'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."LAST_MODIFY_TIME" is N'最后修改时间'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."LAST_MODIFY_ID" is N'更新者ID'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."ROW_VERSION" is N'版本号'
/

COMMENT ON COLUMN "DEPT_MEUM_TREE"."IS_DELETED" is N'删除标识'
/
...
execute immediate 'CREATE TABLE "ESSENTIAL_DOCUMENTS" (
    "ID" NVARCHAR2(50) NOT NULL,
    "DEPT_CODE" NVARCHAR2(100) NOT NULL,
    "FATHER_MEUMID" NVARCHAR2(50) NOT NULL,
...
COMMENT ON COLUMN "FILES_HIS"."MEUM_ID" is N'病历目录表ID'
/
...
COMMENT ON COLUMN "FILES_HIS"."DATA_TYPE" is N'数据类型 1 门诊 2 住院'
/
...
execute immediate 'CREATE TABLE "FILES_OTHER" (
    "ID" NVARCHAR2(50) NOT NULL,
    "ARCHIVE_ID" NVARCHAR2(50) NOT NULL,
    "MEUM_ID" NVARCHAR2(50) NOT NULL,
    "FILE_ID" NVARCHAR2(50) NOT NULL,
    ...
    "STORAGE_STATE" NVARCHAR2(10),
    "REMARK" NVARCHAR2(200),
    "SOURCE_CODE" NVARCHAR2(10),
    "FILE_CATEGORY_CODE" NVARCHAR2(10),
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    "CREATION_TIME" TIMESTAMP(7) NOT NULL,
    "LAST_MODIFY_TIME" TIMESTAMP(7),
    "LAST_MODIFY_ID" NVARCHAR2(50),
    "ROW_VERSION" RAW(8) NOT NULL,
    "IS_DELETED" NUMBER(1) NOT NULL,
    CONSTRAINT "PK_FILES_OTHER" PRIMARY KEY ("ID")
)';
END;
/

CREATE OR REPLACE TRIGGER "rowversion_FILES_OTHER"
BEFORE INSERT OR UPDATE ON "FILES_OTHER"
FOR EACH ROW
BEGIN
  :NEW."ROW_VERSION" := UTL_RAW.CAST_FROM_BINARY_INTEGER(UTL_RAW.CAST_TO_BINARY_INTEGER(NVL(:OLD."ROW_VERSION", '00000000')) + 1);
END;
...
COMMENT ON TABLE "FILES_OTHER" is N'其他文件'
/

COMMENT ON COLUMN "FILES_OTHER"."ID" is N'主键ID'
/

COMMENT ON COLUMN "FILES_OTHER"."ARCHIVE_ID" is N'档案号ID'
/

COMMENT ON COLUMN "FILES_OTHER"."MEUM_ID" is N'病历目录表ID'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_ID" is N'文件唯-ID'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_TRUENAME" is N'文件原名称'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_SAVENAME" is N'文件保存后名称'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_TYPE" is N'文件类型格式'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_PATH" is N'文件存储路径'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_SIZE" is N'文件大小'
/

COMMENT ON COLUMN "FILES_OTHER"."ORDER_NO" is N'排序号'
/

COMMENT ON COLUMN "FILES_OTHER"."STATUS" is N'状态【物理文件上传状态】'
/

COMMENT ON COLUMN "FILES_OTHER"."STORAGE_STATE" is N'文件存储状态【临时、正式】'
/

COMMENT ON COLUMN "FILES_OTHER"."REMARK" is N'备注'
/

COMMENT ON COLUMN "FILES_OTHER"."SOURCE_CODE" is N'文件来源于哪个系统'
/

COMMENT ON COLUMN "FILES_OTHER"."FILE_CATEGORY_CODE" is N'文件分类编码'
/

COMMENT ON COLUMN "FILES_OTHER"."CREATOR_ID" is N'创建人ID'
/

COMMENT ON COLUMN "FILES_OTHER"."CREATION_TIME" is N'创建时间'
/

COMMENT ON COLUMN "FILES_OTHER"."LAST_MODIFY_TIME" is N'最后修改时间'
/

COMMENT ON COLUMN "FILES_OTHER"."LAST_MODIFY_ID" is N'更新者ID'
/

COMMENT ON COLUMN "FILES_OTHER"."ROW_VERSION" is N'版本号'
/

COMMENT ON COLUMN "FILES_OTHER"."IS_DELETED" is N'删除标识'
/
...
execute immediate 'CREATE TABLE "INPATIENT_INFO" (
    ...
    "ADMISS_ID" NVARCHAR2(50) NOT NULL,
    "INPATIENT_ID" NVARCHAR2(50) NOT NULL,
    "VISIT_ID" NUMBER(10) NOT NULL,
    "ORG_CODE" NVARCHAR2(50) NOT NULL,
    "HOSP_CODE" NVARCHAR2(50),
    "INPUT_CODE" NVARCHAR2(50),
    ...
    "ENTER_DEPT" NVARCHAR2(100) NOT NULL,
    "ENTER_WARD_CODE" NVARCHAR2(100) NOT NULL,
...
execute immediate 'CREATE TABLE "OUTPATIENT_INFO" (
    "ARCHIVE_ID" NVARCHAR2(50) NOT NULL,
    "HOSP_RECORD_ID" NVARCHAR2(50) NOT NULL,
    ...
    "ENTER_DEPT_CODE" NVARCHAR2(100) NOT NULL,
    "OUT_DEPT_CODE" NVARCHAR2(100) NOT NULL,
    "OUT_WARD_CODE" NVARCHAR2(100),
    "DOCTOR_KZR_CODE" NVARCHAR2(20),
...
COMMENT ON COLUMN "PROCESS_DESIGN"."ORG_CODE" is N'机构编码'
/
...
execute immediate 'CREATE TABLE "RECALL_APPLY" (
    "ID" NVARCHAR2(50) NOT NULL,
    "ARCHIVE_ID" NVARCHAR2(50) NOT NULL,
    "APPLY_NAME" NVARCHAR2(30) NOT NULL,
    "APPLY_REASON" NVARCHAR2(200) NOT NULL,
    "ATTACHMENT_MATERIALS" NVARCHAR2(200) NOT NULL,
    "IS_END" NUMBER(1) NOT NULL,
    "PROCESS_DESIGN_ID" NVARCHAR2(50) NOT NULL,
    "CURRENT_APPROVAL_NODE_ID" NVARCHAR2(50),
    "CURRENT_APPROVAL_NODE_NAME" NVARCHAR2(50),
    "CURRENT_STATUS" NVARCHAR2(20) NOT NULL,
    "NODE_APPROVAL_NAME" NVARCHAR2(20),
    "APPLY_PERSON_NAME" NVARCHAR2(20) NOT NULL,
    "ORG_CODE" NVARCHAR2(50) NOT NULL,
    "HOSP_CODE" NVARCHAR2(50) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    ...
    "ROW_VERSION" RAW(8) NOT NULL,
    "IS_DELETED" NUMBER(1) NOT NULL,
    CONSTRAINT "PK_RECALL_APPLY" PRIMARY KEY ("ID")
)';
END;
/

CREATE OR REPLACE TRIGGER "rowversion_RECALL_APPLY"
BEFORE INSERT OR UPDATE ON "RECALL_APPLY"
FOR EACH ROW
BEGIN
  :NEW."ROW_VERSION" := UTL_RAW.CAST_FROM_BINARY_INTEGER(UTL_RAW.CAST_TO_BINARY_INTEGER(NVL(:OLD."ROW_VERSION", '00000000')) + 1);
END;
...
COMMENT ON TABLE "RECALL_APPLY" is N'召回申请'
/

COMMENT ON COLUMN "RECALL_APPLY"."ID" is N'主键ID'
/

COMMENT ON COLUMN "RECALL_APPLY"."ARCHIVE_ID" is N'档案号'
/

COMMENT ON COLUMN "RECALL_APPLY"."APPLY_NAME" is N'申请名称'
/

COMMENT ON COLUMN "RECALL_APPLY"."APPLY_REASON" is N'申请原因'
/

COMMENT ON COLUMN "RECALL_APPLY"."ATTACHMENT_MATERIALS" is N'附件材料'
/

COMMENT ON COLUMN "RECALL_APPLY"."IS_END" is N'是否结束'
/

COMMENT ON COLUMN "RECALL_APPLY"."PROCESS_DESIGN_ID" is N'流程模板ID'
/

COMMENT ON COLUMN "RECALL_APPLY"."CURRENT_APPROVAL_NODE_ID" is N'当前审批节点ID'
/

COMMENT ON COLUMN "RECALL_APPLY"."CURRENT_APPROVAL_NODE_NAME" is N'当前审批节点名称'
/

COMMENT ON COLUMN "RECALL_APPLY"."CURRENT_STATUS" is N'状态'
/

COMMENT ON COLUMN "RECALL_APPLY"."NODE_APPROVAL_NAME" is N'当前节点审批人名称'
/

COMMENT ON COLUMN "RECALL_APPLY"."APPLY_PERSON_NAME" is N'申请人姓名'
/

COMMENT ON COLUMN "RECALL_APPLY"."ORG_CODE" is N'机构编码'
/

COMMENT ON COLUMN "RECALL_APPLY"."HOSP_CODE" is N'院区编码'
/

COMMENT ON COLUMN "RECALL_APPLY"."CREATOR_ID" is N'创建人ID'
/

COMMENT ON COLUMN "RECALL_APPLY"."CREATION_TIME" is N'创建时间'
/

COMMENT ON COLUMN "RECALL_APPLY"."LAST_MODIFY_TIME" is N'最后修改时间'
/

COMMENT ON COLUMN "RECALL_APPLY"."LAST_MODIFY_ID" is N'更新者ID'
/

COMMENT ON COLUMN "RECALL_APPLY"."ROW_VERSION" is N'版本号'
/

COMMENT ON COLUMN "RECALL_APPLY"."IS_DELETED" is N'删除标识'
/
...
execute immediate 'CREATE TABLE "ARCHIVE_APPROVER" (
    ...
    "Work_Flow_Status" NVARCHAR2(20) NOT NULL,
    "APPROVAL_RESULT" NVARCHAR2(50) NOT NULL,
...
COMMENT ON COLUMN "ARCHIVE_APPROVER"."Work_Flow_Status" is N'流程状态'
/
...
execute immediate 'CREATE TABLE "RECALL_APPLY_AND_ARCHIVAL" (
    "ID" NVARCHAR2(50) NOT NULL,
    "ARCHIVAL_ID" NVARCHAR2(50) NOT NULL,
    "RECALL_APPLY_ID" NVARCHAR2(50) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    "CREATION_TIME" TIMESTAMP(7) NOT NULL,
    "LAST_MODIFY_TIME" TIMESTAMP(7),
    "LAST_MODIFY_ID" NVARCHAR2(50),
    "ROW_VERSION" RAW(8) NOT NULL,
    "IS_DELETED" NUMBER(1) NOT NULL,
    CONSTRAINT "PK_RECALL_APPLY_AND_ARCHIVAL" PRIMARY KEY ("ID"),
    CONSTRAINT "FK_RECALL_APPLY_ID" FOREIGN KEY ("RECALL_APPLY_ID") REFERENCES "RECALL_APPLY" ("ID") ON DELETE CASCADE
)';
END;
/

CREATE OR REPLACE TRIGGER "rowversion_RECALL_APPLY_AND_ARCHIVAL"
BEFORE INSERT OR UPDATE ON "RECALL_APPLY_AND_ARCHIVAL"
FOR EACH ROW
BEGIN
  :NEW."ROW_VERSION" := UTL_RAW.CAST_FROM_BINARY_INTEGER(UTL_RAW.CAST_TO_BINARY_INTEGER(NVL(:OLD."ROW_VERSION", '00000000')) + 1);
END;
...
COMMENT ON TABLE "RECALL_APPLY_AND_ARCHIVAL" is N'召回档案申请关联表'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."ID" is N'主键ID'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."ARCHIVAL_ID" is N'档案号'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."RECALL_APPLY_ID" is N'召回申请ID'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."CREATOR_ID" is N'创建人ID'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."CREATION_TIME" is N'创建时间'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."LAST_MODIFY_TIME" is N'最后修改时间'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."LAST_MODIFY_ID" is N'更新者ID'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."ROW_VERSION" is N'版本号'
/

COMMENT ON COLUMN "RECALL_APPLY_AND_ARCHIVAL"."IS_DELETED" is N'删除标识'
/

BEGIN 

execute immediate 'CREATE TABLE "RECALL_APPROVER" (
    "ID" NVARCHAR2(50) NOT NULL,
    "RECALL_APPLY_ID" NVARCHAR2(50) NOT NULL,
    "Work_Flow_Status" NVARCHAR2(20) NOT NULL,
    "APPROVAL_RESULT" NVARCHAR2(50) NOT NULL,
    ...
    "ROW_VERSION" RAW(8) NOT NULL,
    "IS_DELETED" NUMBER(1) NOT NULL,
    CONSTRAINT "PK_RECALL_APPROVER" PRIMARY KEY ("ID"),
    CONSTRAINT "FK_RECALLAPPROVER_ID" FOREIGN KEY ("RECALL_APPLY_ID") REFERENCES "RECALL_APPLY" ("ID") ON DELETE CASCADE
)';
END;
/

CREATE OR REPLACE TRIGGER "rowversion_RECALL_APPROVER"
BEFORE INSERT OR UPDATE ON "RECALL_APPROVER"
FOR EACH ROW
BEGIN
  :NEW."ROW_VERSION" := UTL_RAW.CAST_FROM_BINARY_INTEGER(UTL_RAW.CAST_TO_BINARY_INTEGER(NVL(:OLD."ROW_VERSION", '00000000')) + 1);
END;
...
COMMENT ON TABLE "RECALL_APPROVER" is N'召回审批'
/

COMMENT ON COLUMN "RECALL_APPROVER"."ID" is N'主键ID'
/

COMMENT ON COLUMN "RECALL_APPROVER"."RECALL_APPLY_ID" is N'召回申请ID'
/

COMMENT ON COLUMN "RECALL_APPROVER"."Work_Flow_Status" is N'流程状态'
/

COMMENT ON COLUMN "RECALL_APPROVER"."APPROVAL_RESULT" is N'审批结果'
/

COMMENT ON COLUMN "RECALL_APPROVER"."APPROVAL_REMARK" is N'审批备注'
/

COMMENT ON COLUMN "RECALL_APPROVER"."APPROVAL_ID" is N'审批人ID'
/

COMMENT ON COLUMN "RECALL_APPROVER"."APPROVAL_DATE_TIME" is N'审批时间'
/

COMMENT ON COLUMN "RECALL_APPROVER"."CREATOR_ID" is N'创建人ID'
/

COMMENT ON COLUMN "RECALL_APPROVER"."CREATION_TIME" is N'创建时间'
/

COMMENT ON COLUMN "RECALL_APPROVER"."LAST_MODIFY_TIME" is N'最后修改时间'
/

COMMENT ON COLUMN "RECALL_APPROVER"."LAST_MODIFY_ID" is N'更新者ID'
/

COMMENT ON COLUMN "RECALL_APPROVER"."ROW_VERSION" is N'版本号'
/

COMMENT ON COLUMN "RECALL_APPROVER"."IS_DELETED" is N'删除标识'
/
...
execute immediate 'CREATE TABLE "NODE_APPROVER" (
    "ID" NVARCHAR2(50) NOT NULL,
    "PROCESS_NODE_ID" NVARCHAR2(50) NOT NULL,
    "APPROVER_ID" NVARCHAR2(50) NOT NULL,
    "APPROVER_ACCOUNT" NVARCHAR2(30) NOT NULL,
    "APPROVER_NAME" NVARCHAR2(30) NOT NULL,
    "CREATOR_ID" NVARCHAR2(50) NOT NULL,
    "CREATION_TIME" TIMESTAMP(7) NOT NULL,
    "LAST_MODIFY_TIME" TIMESTAMP(7),
    "LAST_MODIFY_ID" NVARCHAR2(50),
    ...
    CONSTRAINT "FK_PROCESS_NODE_ID" FOREIGN KEY ("PROCESS_NODE_ID") REFERENCES "PROCESS_NODE" ("ID") ON DELETE CASCADE
)';
END;
/
...
COMMENT ON COLUMN "NODE_APPROVER"."PROCESS_NODE_ID" is N'节点ID'
/

COMMENT ON COLUMN "NODE_APPROVER"."APPROVER_ID" is N'审批人ID'
/

COMMENT ON COLUMN "NODE_APPROVER"."APPROVER_ACCOUNT" is N'审批人登录账户'
/

COMMENT ON COLUMN "NODE_APPROVER"."APPROVER_NAME" is N'审批人姓名'
/
...
CREATE INDEX "IX_APPROVER_ID" ON "NODE_APPROVER" ("PROCESS_NODE_ID")
/

CREATE INDEX "IX_PROCESS_DESIGN_ID" ON "PROCESS_NODE" ("PROCESS_DESIGN_ID")
/

CREATE INDEX "IX_RECALL_APPLY_ID" ON "RECALL_APPLY_AND_ARCHIVAL" ("RECALL_APPLY_ID")
/

CREATE INDEX "IX_RECALLAPPROVER_ID" ON "RECALL_APPROVER" ("RECALL_APPLY_ID")
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240409035650_init', N'6.0.24')
/
