...
execute immediate 'CREATE TABLE "ARCHIVE_APPLY" (
    ...
    "CURRENT_STATUS" NVARCHAR2(10) NOT NULL,
...
execute immediate 'CREATE TABLE "ARCHIVE_APPROVER" (
    ...
    "APPROVAL_ID" NVARCHAR2(10) NOT NULL,
...
execute immediate 'CREATE TABLE "INPATIENT_INFO" (
    ...
    "ORG_CODE" NVARCHAR2(20) NOT NULL,
    "HOSP_CODE" NVARCHAR2(10) NOT NULL,
    "INPUT_CODE" NVARCHAR2(20) NOT NULL,
    "HospName" NVARCHAR2(2000) NOT NULL,
    "OrgName" NVARCHAR2(2000) NOT NULL,
    "NAME" NVARCHAR2(10) NOT NULL,
    "SEX_TYPE" NVARCHAR2(4) NOT NULL,
    "DATE_OF_BIRTH" TIMESTAMP(7) NOT NULL,
    "AGE" NUMBER(10) NOT NULL,
    "ID_CARD" NVARCHAR2(18) NOT NULL,
    "ENTER_DATE" TIMESTAMP(7) NOT NULL,
    "ENTER_DEPT" NVARCHAR2(15) NOT NULL,
    "ENTER_WARD_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_ZYYS_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_ZZYS_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_KZR_CODE" NVARCHAR2(20) NOT NULL,
    "CHARGE_NURSE_CODE" NVARCHAR2(20) NOT NULL,
    "GET_DATE" TIMESTAMP(7) NOT NULL,
    "PmrfType" NVARCHAR2(2000) NOT NULL,
    "SIGN_STATUS" NVARCHAR2(2) NOT NULL,
...
execute immediate 'CREATE TABLE "OUTPATIENT_INFO" (
    ...
    "OUT_WARD_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_KZR_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_ZRYS_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_ZZYS_CODE" NVARCHAR2(20) NOT NULL,
    "DOCTOR_ZYYS_CODE" NVARCHAR2(20) NOT NULL,
    "CHARGE_NURSE_CODE" NVARCHAR2(20) NOT NULL,
    "BASY_STATUS" NVARCHAR2(20) NOT NULL,
    "DAYS" NUMBER(10) NOT NULL,
    "IS_OVERDATE" NVARCHAR2(20) NOT NULL,
    "CREATE_DATE_TIME" TIMESTAMP(7) NOT NULL,
    "FILE_FLAG" NVARCHAR2(20) NOT NULL,
    "STATUS" NVARCHAR2(20) NOT NULL,
    "CASE_TYPE" NVARCHAR2(20) NOT NULL,
    "IS_LOCK" NVARCHAR2(20) NOT NULL,
...
execute immediate 'CREATE TABLE "SYS_OPER_LOG" (
    ...
    "OPERATOR_TYPE" NUMBER(10) NOT NULL,
...
VALUES (N'20240322093137_init', N'6.0.24')
/

ALTER TABLE "PROCESS_NODE" ADD "NODE_MAP_WORKFLOW_STATUS" NUMBER(10) DEFAULT 0 NOT NULL
/

COMMENT ON COLUMN "PROCESS_NODE"."NODE_MAP_WORKFLOW_STATUS" is N'节点对应流程状态'
/

ALTER TABLE "PROCESS_DESIGN" ADD "DEPT_CODE" NVARCHAR2(20) NOT NULL
/

COMMENT ON COLUMN "PROCESS_DESIGN"."DEPT_CODE" is N'科室编码'
/

ALTER TABLE "PROCESS_DESIGN" ADD "PROCESS_TEMP_TYPE" NUMBER(10) DEFAULT 0 NOT NULL
/
...
begin 
  ...
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'STATUS' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "STATUS" NUMBER(10) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "STATUS" NUMBER(10) NOT NULL';
 end if;
end;
/
...
begin 
   select nullable into l_nullable 
   from user_tab_columns 
  where table_name = 'ARCHIVE_APPROVER' 
  and column_name = 'APPROVAL_RESULT' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVE_APPROVER" MODIFY "APPROVAL_RESULT" NUMBER(10) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVE_APPROVER" MODIFY "APPROVAL_RESULT" NUMBER(10) NOT NULL';
 end if;
end;
/
...
begin 
   select nullable into l_nullable 
   from user_tab_columns 
  where table_name = 'ARCHIVE_APPLY' 
  and column_name = 'CURRENT_STATUS' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVE_APPLY" MODIFY "CURRENT_STATUS" NUMBER(10) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVE_APPLY" MODIFY "CURRENT_STATUS" NUMBER(10) NOT NULL';
 end if;
end;
/
...
execute immediate 'CREATE TABLE "ARCHIVER_MEUM" (
    ...
    "MEUM_TYPE" NVARCHAR2(4) NOT NULL,
...
ALTER TABLE "ARCHIVE_APPROVER" ADD CONSTRAINT "FK_ARCHIVE_APPLY_ID" FOREIGN KEY ("ARCHIVE_APPLY_ID") REFERENCES "ARCHIVE_APPLY" ("ID") ON DELETE CASCADE
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240325013332_init_1', N'6.0.24')
/
...
begin 
   select nullable into l_nullable 
   from user_tab_columns 
  where table_name = 'PROCESS_DESIGN' 
  and column_name = 'PROCESS_TEMP_TYPE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "PROCESS_DESIGN" MODIFY "PROCESS_TEMP_TYPE" NVARCHAR2(20) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "PROCESS_DESIGN" MODIFY "PROCESS_TEMP_TYPE" NVARCHAR2(20) NOT NULL';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVE_APPROVER" MODIFY "APPROVAL_ID" NVARCHAR2(50) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVE_APPROVER" MODIFY "APPROVAL_ID" NVARCHAR2(50) NOT NULL';
 end if;
end;
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240325094824_up_PROCESS_DESIGN', N'6.0.24')
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'OUT_WARD_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "OUT_WARD_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "OUT_WARD_CODE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'IS_OVERDATE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "IS_OVERDATE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "IS_OVERDATE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'IS_LOCK' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "IS_LOCK"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "IS_LOCK" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "INPUT_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "INPUT_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "ID_CARD"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "ID_CARD" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'HOSP_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "HOSP_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "HOSP_CODE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'DOCTOR_ZZYS_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_ZZYS_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_ZZYS_CODE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'DOCTOR_ZYYS_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_ZYYS_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_ZYYS_CODE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'DOCTOR_ZRYS_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_ZRYS_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_ZRYS_CODE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'DOCTOR_KZR_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_KZR_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DOCTOR_KZR_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DAYS"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "DAYS" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'CREATE_DATE_TIME' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "CREATE_DATE_TIME"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "CREATE_DATE_TIME" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'CHARGE_NURSE_CODE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "CHARGE_NURSE_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "CHARGE_NURSE_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "CASE_TYPE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "CASE_TYPE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'OUTPATIENT_INFO' 
  and column_name = 'BASY_STATUS' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "BASY_STATUS"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "BASY_STATUS" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "AGE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "OUTPATIENT_INFO" MODIFY "AGE" ';
 end if;
end;
/
...
begin 
   select nullable into l_nullable 
   from user_tab_columns 
  where table_name = 'INPATIENT_INFO' 
  and column_name = 'SIGN_STATUS' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "SIGN_STATUS"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "SIGN_STATUS" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'INPATIENT_INFO' 
  and column_name = 'OrgName' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "OrgName"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "OrgName" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "INPUT_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "INPUT_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "ID_CARD"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "ID_CARD" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "HOSP_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "HOSP_CODE" ';
 end if;
end;
/
...
begin 
   ...
   from user_tab_columns 
  where table_name = 'INPATIENT_INFO' 
  and column_name = 'GET_DATE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "GET_DATE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "GET_DATE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "DOCTOR_ZZYS_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "DOCTOR_ZZYS_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "DOCTOR_ZYYS_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "DOCTOR_ZYYS_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "DOCTOR_KZR_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "DOCTOR_KZR_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "CHARGE_NURSE_CODE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "CHARGE_NURSE_CODE" ';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "AGE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "INPATIENT_INFO" MODIFY "AGE" ';
 end if;
end;
/
...
begin 
   select nullable into l_nullable 
   from user_tab_columns 
  where table_name = 'ARCHIVER_MEUM' 
  and column_name = 'MEUM_TYPE' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVER_MEUM" MODIFY "MEUM_TYPE"  NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "ARCHIVER_MEUM" MODIFY "MEUM_TYPE" ';
 end if;
end;
/
...
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240325103909_init_m', N'6.0.24')
/
...
begin 
   select nullable into l_nullable 
   from user_tab_columns 
  where table_name = 'SYS_OPER_LOG' 
  and column_name = 'STATUS' 
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "SYS_OPER_LOG" MODIFY "STATUS" NVARCHAR2(20) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "SYS_OPER_LOG" MODIFY "STATUS" NVARCHAR2(20) NOT NULL';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "SYS_OPER_LOG" MODIFY "OPERATOR_TYPE" NVARCHAR2(20) ';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "SYS_OPER_LOG" MODIFY "OPERATOR_TYPE" NVARCHAR2(20) NOT NULL';
 end if;
end;
/
...
;
   if l_nullable = 'N' then 
        EXECUTE IMMEDIATE 'ALTER TABLE "SYS_OPER_LOG" MODIFY "BUSINESS_TYPE" NVARCHAR2(20) NULL';
 else 
        EXECUTE IMMEDIATE 'ALTER TABLE "SYS_OPER_LOG" MODIFY "BUSINESS_TYPE" NVARCHAR2(20)';
 end if;
end;
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240326004544_up_SysOperLog', N'6.0.24')
/

ALTER TABLE "PROCESS_DESIGN" DROP COLUMN "INPUT_CODE"
/

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES (N'20240326071530_up_ProcessDesign', N'6.0.24')
/
